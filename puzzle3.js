...
var myGameArea = {
  ...
  draw: function() {
    ...
    this.context.fillText("2", tileSize / 2, tileSize * 5 - 10);
    this.context.fillText("2", tileSize * 3 + tileSize / 2 - 5, tileSize * 5 - 10);

    this.context.fillText("3", tileSize + tileSize / 2 - 5, tileSize * 5 - 10);
    this.context.fillText("3", tileSize * 5 - 10, tileSize * 3 + tileSize / 2 + 5);

    this.context.fillText("4", tileSize + tileSize / 2 - 5, 10);
    this.context.fillText("4", tileSize * 5 - 10, tileSize + tileSize / 2);

    this.context.fillText("5", tileSize / 2 - 5, 10);
    this.context.fillText("5", tileSize * 5 - tileSize / 2 - 5, tileSize * 5 - 10);

    this.context.fillText("6", tileSize * 5 - 10, tileSize / 2);
    this.context.fillText("6", tileSize * 5 - 10, tileSize * 2 + tileSize / 2);
